...
window=Tk()
window.title("Welcome to TIC TAE TOE GAME(:")
window.geometry("400x400")

lbl1=Label(window,text="Play game",font=('Helvetica','15'))
lbl1.grid(row=0,column=0,columnspan=3)
lbl2=Label(window,text="Player 1: X",font=('Helvetica','10'))
lbl2.grid(row=1,column=0)
lbl3=Label(window,text="Player 2: O",font=('Helvetica','10'))
...
def check():
    ...
    if b1==b2 and b1==b3 and b1=="O" or b1==b2 and b1==b3 and b1=="X":
        win(btn1["text"])
    elif b4==b5 and b4==b6 and b4=="O" or b4==b5 and b4==b6 and b4=="X":
        win(btn4["text"])
    elif b7==b8 and b7==b9 and b7=="O" or b7==b9 and b7==b8 and b7=="X":
        win(btn7["text"])
    elif b1==b4 and b1==b7 and b1=="O" or b1==b4 and b1==b7 and b1=="X":
        win(btn1["text"])
    elif b2==b5 and b2==b8 and b2=="O" or b2==b5 and b2==b8 and b2=="X":
        win(btn2["text"])
    elif b3==b6 and b9==b3 and b3=="O" or b3==b6 and b9==b3 and b3=="X":
        win(btn3["text"])
    elif b1==b5 and b1==b9 and b1=="O" or b1==b5 and b1==b9 and b1=="X":
        win(btn1["text"])
    elif b3==b5 and b3==b7 and b3=="O" or b3==b5 and b3==b7 and b3=="X":
        win(btn3["text"])
    elif flag==10:
